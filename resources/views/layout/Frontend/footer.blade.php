                ...
                <div class="col-lg-3  col-md-6 col-sm-6">
                    <div class="single-footer-widget mail-chimp">
                        ...
                        <ul class="instafeed d-flex flex-wrap">
                            <li><img src="{{asset('custom/frontend/img/i1.jpg')}}" alt=""></li>
                            <li><img src="{{asset('custom/frontend/img/i2.jpg')}}" alt=""></li>
                            <li><img src="{{asset('custom/frontend/img/i3.jpg')}}" alt=""></li>
                            <li><img src="{{asset('custom/frontend/img/i4.jpg')}}" alt=""></li>
                            <li><img src="{{asset('custom/frontend/img/i5.jpg')}}" alt=""></li>
                            <li><img src="{{asset('custom/frontend/img/i6.jpg')}}" alt=""></li>
                            <li><img src="{{asset('custom/frontend/img/i7.jpg')}}" alt=""></li>
                            <li><img src="{{asset('custom/frontend/img/i8.jpg')}}" alt=""></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-12">
                    <p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                        Copyright &copy;<script>document.write(new Date().getFullYear());</script> Lathhik All Right Reserved</a>
