            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Add Place
                                <small>you can add Place here</small>
                            </h2>
                        ...
                        <div class="x_content">
                            ...
                            <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"
                                  action="{{route('add-new-place')}}" method="post" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" id="last-name" name="country" required="required"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-4 col-xs-12">
                                        <textarea class="resizable_textarea form-control"
                                                  placeholder="Place Description" name="description">
